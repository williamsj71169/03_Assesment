...
def shape_squrec(shape):
    ...
    response = input("Are you a fluffy {}? ".format(shape))
    ...
    sr_perimeter = round_up(perimeter, round_to)
    print("perimeter is {} {}".format(sr_perimeter, unit))

    area = r_side_12 * r_side_34
    sr_area = round_up(area, round_to)
    print("area is {} {} squared".format(sr_area, unit))
...
def shape_tripar(shape2):
    ...
    response = input("Are you a fluffy {}? ".format(shape2))
